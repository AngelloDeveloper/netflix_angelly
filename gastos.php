            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-danger">Registrar Gasto</h6>
                            </div>
                            <div class="card-body">
                                <form action="insertarGasto.php" method="post">
                                    ...
                                    <textarea name="descripcion" class="form-control mb-3" placeholder = "Descripción del gasto"></textarea>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-danger">Gastos Registrados</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="tablax" class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php  
                                                ...
                                                $result = mysqli_query($conexion, "SELECT ref.refCod, ref.dateRef, ref.monRef,ref.status, ban.typBan FROM referencia ref 
