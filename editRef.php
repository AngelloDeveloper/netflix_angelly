<?php
  ...
  #update
    if(isset($_GET['refCod'])){
        $refCod = $_GET['refCod'];
        $query = "SELECT * FROM referencia WHERE refCod = $refCod";
...
<body id="page-top">
                    ...
                    <div class="offset-3 col-md-6">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-danger">Actualizar Transferencias</h6>
                            </div>
                            <div class="card-body">
                                
                                <form id="FormSendUpdate">
                                    <input type="hidden" class="form-control mb-3" name="id" value ="<?php echo $id?>" id="id" />
                                    <input type="text" class="form-control mb-3" name="ref" value ="<?php echo $ref?>" id="ref" placeholder="Actualiza la Referencia" required pattern="[0-9]{4,30}" title="Ingresar 4 digitos">
                                    <input type="text" class="form-control mb-3" name="ban" value ="<?php echo $banco?>" id="ref" placeholder="Actualiza el Banco">                                   
                                    <input type="datetime-local" class="form-control mb-3" name="date" value="<?= $date; ?>" placeholder="Fecha y Hora" required>
                                    <input type="text" style="margin-bottom: 0 !important" class="form-control mb-3" name="monto" value ="<?php echo $monto?>" id="monto" placeholder="Actualizar el Monto" step="any" required >                                   
                                    <span id="alertMessages"></span>
                                    <button style="margin-top: 20px !important;" class="btn btn-secondary btn-block">
                                        Actualizar
                                    </button>  
                                </form> 
                            </div>
    ...
    <!--validacion de monto decimal (float)-->
    <script src="js/edifRef.js"></script>
</body>
