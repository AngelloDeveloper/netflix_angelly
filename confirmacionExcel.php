        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">                    
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Página Confirmación de Referencias por excel</h1>
                        ...
                        <div class="offset-3 col-md-5">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-danger">Subir Archivo Excel</h6>
                                </div>
                                <div class="card-body">
                                  
                                    <form action="confirmacionExcel.php" method="post" enctype="multipart/form-data">
                                        <label>Bancos</label>
                                       ...
                                       <br>
                                       <input class="btn btn-danger form-control" type="submit" value="cargar archivo">
                                    </form> 
                                </div>
                            </div>    
                                    ...
                                    <?php
                                      ...
                                      echo '  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            if($_FILES) {
                                                    ...
                                                    $typBan = "SELECT typBan FROM `banco` WHERE idBan = $banco";
                                                    $result = mysqli_query($conexion, $typBan);  
                                                    while($mostrar = mysqli_fetch_array($result))
                                                    {
                                                     $typBanc = $mostrar['typBan'];
                                                    }
                                                    
                                                    require('import.php');
                                                    $import = new import($archivo, $conexion, $banco, $typBanc);
